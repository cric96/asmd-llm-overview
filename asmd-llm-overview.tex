...
\begin{frame}{Natural Language Processing}
    ...
    \begin{exampleblock}{Approaches}
        \begin{itemize}
            ...
            \item \textbf{ML/Deep Learning:} Algorithms learn from data; neural networks model complex patterns (RNN~\cite{DBLP:journals/corr/0001KYS17}, LSTM~\cite{DBLP:journals/neco/HochreiterS97}, GRU~\cite{DBLP:conf/mwscas/DeyS17}, etc.).
